...
- [`html2canvas`](https://html2canvas.hertzen.com/) — unduh tampilan Daftar Pekerjaan jadi gambar JPG
...
Fitur **Daftar Pekerjaan** (tab baru, terbuka untuk Owner maupun kasir — mirip
...
Daftar Pekerjaan — persis seperti melepas kertas dari papan tulis fisik, tapi
data transaksinya sendiri tidak dihapus, tetap ada di Riwayat/Laporan).
Sebelum kolom ini ada, tab Daftar Pekerjaan tetap terbuka tapi tombol ubah status
akan gagal dengan toast error — transaksi tetap tersimpan normal, hanya
fitur Daftar Pekerjaan-nya yang belum aktif.

Supaya kerjaan **Paket Bulanan & Tempo** juga ikut muncul di Daftar Pekerjaan
...
Bulanan/Tempo — keduanya ikut muncul di Daftar Pekerjaan. Untuk timbangan kg
